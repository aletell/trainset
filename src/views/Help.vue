      ...
      <div class="px-40 flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col max-w-[960px] flex-1 text-white">
          <div class="flex flex-col gap-4 px-4 py-10">
            <h1 class="text-2xl font-bold">Help with TRAINSET</h1>
            <h2 class="text-lg font-semibold">Input data format</h2>
            <p class="text-[#9cabba]">TRAINSET only accepts specific file formats. This <a class="underline" href="https://raw.githubusercontent.com/Geocene/trainset/master/sample_trainset.csv" target="_blank">sample CSV</a> is formatted correctly. Files uploaded to TRAINSET must have four comma-delimited columns with the header: <code>series, timestamp, value, label</code>; <code>null</code> data are not allowed.</p>
            <ul class="list-disc list-inside text-[#9cabba]">
              <li><code>series</code> is a unique name of the time series you are labeling.</li>
              <li><code>timestamp</code> is in <a href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank" class="underline">ISO 8601 format</a>.</li>
              <li><code>value</code> is a numeric scalar.</li>
              <li><code>label</code> is an integer representation of a boolean; <code>0==FALSE</code> and <code>1==TRUE</code>.</li>
            </ul>
            <h2 class="text-lg font-semibold pt-4">Labeling and Navigating</h2>
            <p class="text-[#9cabba]">Labels can be toggled by clicking on points or brushed across many points. Use the context bar or keyboard shortcuts to navigate your data.</p>
            <h2 class="text-lg font-semibold pt-4">Exporting</h2>
            <p class="text-[#9cabba]">After labeling, export a CSV with the <code>-labeled</code> suffix.</p>
            <h2 class="text-lg font-semibold pt-4">Privacy</h2>
            <p class="text-[#9cabba] mb-4">TRAINSET runs entirely client-side. Your data never leaves your browser. See the <a href="https://github.com/Geocene/trainset" target="_blank" class="underline">GitHub README</a> for details.</p>
          </div>
